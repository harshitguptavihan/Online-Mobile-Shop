...
<form  action="addphonecode.php" method="POST" class="form" enctype="multipart/form-data">
<div class="row">
<div class="col-sm-12 text-center">
<h2 style="font-weight:bold;color:#161F27">Add New Phone</h2> 
</div>
</div>
<br><br>
<div class="col-sm-12">
          <div class="row">
          <div class="col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Mobile Brand:</span><br> <input type="text" class="form-control" name="brand">
          </div>
		  <div class="col-sm-offset-2 col-sm-5">
		  <span style="font-weight:bold;font-size:1.1em">Mobile Name:</span><br> <input type="text" class="form-control" name="name">
		  </div>
		  
		  </div><br>
		  <div class="row">
		  <div class="col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Mobile series:</span><br> <input type="text" class="form-control" name="series">
          </div>
		  <div class="col-sm-offset-2 col-sm-5">
		  <span style="font-weight:bold;font-size:1.1em">Mobile Color:</span><br> <input type="text" class="form-control" name="color">
		  </div>
		  </div><br>
 ...
 <div class="row">
        ...
        <span style="font-weight:bold;font-size:1.1em">Category:</span><br> <select name="ctgry" class="form-control">
           ...
           <option >Budget Phone</option>
           <option >New Launches</option>
           <option >Camera Phone</option>
           <option >Best In Performance </option>
           <option >Big Battery Phone</option>
           <option >Top Selling Phone</option>
...
<div class="row">
          <div class="col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Mobile Quantity:</span><br> <input type="number" class="form-control" name="qty">
          </div>
		   <div class="col-sm-offset-2 col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Mobile Price:</span><br> <input type="number" class="form-control" name="price">
          </div>
		  </div><br>
...
<br><br>
         ...
         <div class="row">
          ...
          <input type="submit" class="btn  btn-primary form-control" value="Proceed" name="sub">
          </div>
          </div>
          </div>
</form>
