...
{
	$pcount=$row7['count(pid)'];
    $_SESSION['phonecont']=$pcount;
}
            ...
            <div class="col-sm-12" id="content">
                ...
                <nav>
                    <div class="container-fluid">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			                <a href="addphone.php">
                            <button style="height:34px;width:130px;border-radius:5px;box-shadow:2px 2px 5px gray;" class="button btn"><span style="font-size:1.2em;font-weight:bold">+ Add New Phone</span>
                            </button>
                            </a> 
   
                    </div>
               <?php
include("tablephone.php");
?>     
                </nav>
