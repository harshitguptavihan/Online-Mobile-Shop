...
<form  action="addaccessorycode.php" method="POST" class="form" enctype="multipart/form-data">
<div class="row">
<div class="col-sm-12 text-center">
<h2 style="font-weight:bold;color:#161F27">Add New Accessory</h2> 
</div>
</div>
<br><br>
<div class="col-sm-12">
          <div class="row">
          <div class="col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Accessory Brand:</span><br> <input type="text" class="form-control" name="brand">
          </div>
		  <div class="col-sm-offset-2 col-sm-5">
		  <span style="font-weight:bold;font-size:1.1em">Accessory Name:</span><br> <input type="text" class="form-control" name="name">
		  </div>
		  
		  </div><br>
		  <div class="row">
		  <div class="col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Accessory Series:</span><br> <input type="text" class="form-control" name="series">
          </div>
		  <div class="col-sm-offset-2 col-sm-5">
		  <span style="font-weight:bold;font-size:1.1em">Accessory Color:</span><br> <input type="text" class="form-control" name="color">
		  </div>
		  </div><br>

 <div class="row">
          <div class="col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Category:</span><br> <select name="ctgry" class="form-control">
           <option value="">Select Here</option>
           <option >Bluetooth Devices</option>
           <option >Chargers and USB Cables</option>
           <option >Earphones</option>
           <option >Headphones</option>
           <option >Powerbanks</option>
           <option >Fitness Devices</option>
           <option >Phone Covers</option>
         </select>
          </div>
		  <div class="col-sm-offset-2 col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Type:</span><br> <input type="text" class="form-control" name="type">
          </div>
		  </div><br>

<div class="row">
          <div class="col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Accessory Quantity:</span><br> <input type="number" class="form-control" name="qty">
          </div>
		   <div class="col-sm-offset-2 col-sm-5">
        <span style="font-weight:bold;font-size:1.1em">Accessory Price:</span><br> <input type="number" class="form-control" name="price">
          </div>
		  </div><br>
		  
		  <div class="row">
		  <div class="col-sm-5" style="margin-top:25px">
        <span style="font-weight:bold;font-size:1.1em">Image:</span> <input type="file" name="image" style="display:inline-block">
          </div>
		  </div>
<br>
<div class="row">
<div class="col-sm-12" style="margin-top:25px">
<span style="font-weight:bold;font-size:1.1em">Description:</span><br> <textarea class="form-control" name="descr" col="5" rows="5"></textarea>
</div>
</div>		
<br><br>
         ...
         <div class="row">
          ...
          <input type="submit" class="btn  btn-primary form-control" value="Add Accessory" name="sub">
          </div>
          </div>
          </div>
</form>
