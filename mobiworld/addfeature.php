        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
					...
					<br>
                    <li>
                        <a href="aprofile.php"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Dashboard</a>
...
<form action="addfeaturecode.php" method="POST" class="form" enctype="multipart/form-data">
<div class="row">
<div class="col-sm-12 text-center">
<h2 style="font-weight:bold;color:#161F27">Add Features</h2>
</div>
</div>
<br>
<br>
...
<div class="row">
<div class="col-sm-5">
<span style="font-weight:bold;font-size:1.1em">RAM:</span> <br><input type="text" class="form-control" name="ram">
</div>
<div class="col-sm-offset-2 col-sm-5">
<span style="font-weight:bold;font-size:1.1em">Storage:</span><br> <input type="text" class="form-control" name="rom">
</div>
</div>
<br>
<br>
<div class="row">
<div class="col-sm-5">
<span style="font-weight:bold;font-size:1.1em">Screen Size:</span><br> <input type="text" class="form-control" name="screensize">
</div>
<div class="col-sm-offset-2 col-sm-5">
<span style="font-weight:bold;font-size:1.1em">Camera:</span><br> <input type="text" class="form-control" name="camera">
</div>
</div>
<br>
<br>
<div class="row">
<div class="col-sm-5">
<span style="font-weight:bold;font-size:1.1em">Battery:</span><br> <input type="text" class="form-control" name="battery">
</div>
<div class="col-sm-offset-2 col-sm-5">
<span style="font-weight:bold;font-size:1.1em">Processor:</span><br> <input type="text" class="form-control" name="processor">
</div>
</div>
<br>
<br>
...
<input type="submit" value="Add Phone" class="form-control btn btn-primary" name="sub">
</div>
</form>
</div>
</div>
