...
<form  action="editprofilecode.php?uid=<?php echo $uid; ?>" method="POST" class="form" enctype="multipart/form-data">
<div class="row">
<div class="col-sm-12 text-center">
<h2 style="font-weight:bold;color:#161F27">Edit Profile</h2> 
</div>
</div>
<br><br>
<div class="col-sm-12">
          <div class="row">
          <div class="col-sm-12">
        <span style="font-weight:bold;font-size:1.1em">User Name:</span><br> <input type="text" value="<?php echo $name ;?>" class="form-control" placeholder="Enter Your Name" name="uname">
          </div>
		  ...
		  <div class="row">
		  <div class="col-sm-12">
        <span style="font-weight:bold;font-size:1.1em">Phone:</span><br> <input type="text" value="<?php echo $phone ;?>" class="form-control" placeholder="Enter Your Phone" name="phone">
          </div>
...
<br><br>
         ...
         <div class="row">
          ...
          <input type="submit" class="btn  btn-primary form-control" value="Update Profile" name="sub">
          </div>
          </div>
          </div>
</form>
