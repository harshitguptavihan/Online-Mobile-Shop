...
$id=$_REQUEST['id'];
include("config.php");
$q="select * from tbl_phone where pid='$id' and type='Phone'";
...
<div class="row">
<div class="col-sm-12">
&nbsp;&nbsp;<span class="fa fa-circle" style="color:gray;position:relative;bottom:1px"></span>&nbsp;&nbsp;&nbsp;<h6 style="color:gray;display:inline-block;font-size:13px"><?php echo $row1['ram'];?> RAM |&nbsp;<?php echo $row1['rom'];?> ROM</h6>
</div>
</div>
<div class="row">
<div class="col-sm-12">
&nbsp;&nbsp;<span class="fa fa-circle" style="color:gray;position:relative;bottom:1px"></span>&nbsp;&nbsp;&nbsp;<h6 style="color:gray;display:inline-block;font-size:13px"><?php echo $row1['ss'];?> </h6>
</div>
</div>
<div class="row">
<div class="col-sm-12">
&nbsp;&nbsp;<span class="fa fa-circle" style="color:gray;position:relative;bottom:1px"></span>&nbsp;&nbsp;&nbsp;<h6 style="color:gray;display:inline-block;font-size:13px"><?php echo $row1['camera'];?> </h6>
</div>
</div>
<div class="row">
<div class="col-sm-12">
&nbsp;&nbsp;<span class="fa fa-circle" style="color:gray;position:relative;bottom:1px"></span>&nbsp;&nbsp;&nbsp;<h6 style="color:gray;display:inline-block;font-size:13px"><?php echo $row1['battery'];?> Battery </h6>
</div>
</div>
<div class="row">
<div class="col-sm-12">
&nbsp;&nbsp;<span class="fa fa-circle" style="color:gray;position:relative;bottom:1px"></span>&nbsp;&nbsp;&nbsp;<h6 style="color:gray;display:inline-block;font-size:13px"><?php echo $row1['processor'];?> </h6>
</div>
</div>
<br>
<div class="row">
