...
<?php
include("config.php");
$q="select * from tbl_phone where type='Accessory'";
...
<tr>
 ...
 <td class="column3"><?php echo $SetRow['name']; ?></td>
 <td class="column4"><?php echo $SetRow['color']; ?></td>
 <td class="column5"><button type="button" class="btn btn-info " data-toggle="modal" data-target="#myModal<?php echo $SetRow['pid']; ?>">Update</button> <a href="deleteaccessories.php?pid=<?php echo $SetRow['pid']; ?>" class="btn btn-danger">Delete</a></td>
 </tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<form class="form" action="updateaccessory.php">
