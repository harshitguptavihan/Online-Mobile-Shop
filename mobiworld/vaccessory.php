...
$q="select * from tbl_phone where pid='$id' and type='Accessory'";
...
<a href="addcart.php?id=<?php echo $pid; ?>" class="button_example h3 " style="font-weight:bold;text-decoration:none;"><span class="glyphicon glyphicon-shopping-cart"></span> &nbsp;<span>Add to cart</span></a>
</div>
<div class=" col-sm-4 text-center">
<a href="buycode.php?id=<?php echo $pid;?>" class="button_example1 h3" style="font-weight:bold;text-decoration:none;"><span><img src="photo\flash.png" class="img img-responsive" style="display:inline-block;height:13px"></span> <span>Buy Now</span></a>
</div>
...
<div class="col-sm-12">
&nbsp;&nbsp;&nbsp;<span style="font-size:13px"><?php echo $descr; ?></span>
</div>
</div>
